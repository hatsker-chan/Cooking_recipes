...
class RecipeDto(
    ...
    @SerializedName("extendedIngredients") var extendedIngredients: ArrayList<IngredientDto> = arrayListOf(),
    ...
    @SerializedName("analyzedInstructions") var analyzedInstructions: ArrayList<InstructionStepsJsonContainer> = arrayListOf(),
